                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        <label >Name</label>
                        <input type="text" class="form-control @if($errors->has('blog_category_name')) is-invalid @endif" name="blog_category_name" placeholder="Enter Cateogry name" value="{{old('blog_category_name',$getRecord->name)}}">
                      ...
                      <div class="form-group">
                        <label >Name</label>
                        <input type="text" class="form-control @if($errors->has('title')) is-invalid @endif" name="title" placeholder="Enter Cateogry name" value="{{old('title',$getRecord->name)}}">
