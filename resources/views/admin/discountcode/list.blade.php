                    ...
                    @if ($getRecord->isNotEmpty())
                        @foreach ($getRecord as $value)
                            <tr  class="active">
                              ...
                              <td>
                                <a href="{{route("admin.discount_code.edit",$value->id)}}" class="btn btn-primary">Edit</a>
                                <a href="{{route("admin.discount_code.remove",$value->id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger">Remove</a>
                              </td>
                            </tr>
                        @endforeach
                    @else
