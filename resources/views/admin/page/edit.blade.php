                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        <label >Name</label>
                        <input type="text" class="form-control @if($errors->has('name')) is-invalid @endif" name="name" placeholder="Enter Cateogry name" value="{{old('name',$getRecord->name)}}">
                      ...
                      <div class="form-group">
                        ...
                        <textarea type="text" class="form-control editor" name="discription" placeholder="Discription">{{old('description',$getRecord->description)}}</textarea>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea  class="form-control editor" name="meta_description" placeholder="Meta description" >{{old('meta_description',$getRecord->meta_description)}}</textarea>
                      </div>
                      <div class="form-group">
