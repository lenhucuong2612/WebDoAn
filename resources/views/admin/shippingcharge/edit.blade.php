                ...
                <div class="card card-primary">
                  <form method="post" action="">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        <label >Price</label>
                        <input type="number" class="form-control @if($errors->has('price')) is-invalid @endif" name="price" placeholder="Precent / Amount" value="{{old('percent_amount',$getRecord->price)}}">
