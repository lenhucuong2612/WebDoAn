                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @if($errors->has('button_name')) is-invalid @endif" name="button_name" placeholder="Enter button name" value="{{old('button_name')}}">
                        <p class="invalid-feedback">{{$errors->first('button_name')}}</p>
                      </div>
                      <div class="form-group">
                        <label >Button Link</label>
                        <input type="text" class="form-control @if($errors->has('button_link')) is-invalid @endif" name="button_link" placeholder="Enter button link" value="{{old('button_link')}}">
