...
<head>
    ...
    <title>{{!empty($meta_title)?$meta_title:'Meta title'}}</title>
                            ...
                            <div class="tab-content" id="tab-content-5">
                                ...
                                <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                    <form action="" id="SubmitFormRegister" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label for="register-email">Your name <span style="color:red">*</span> </label>
                                        ...
                                        <div class="form-footer">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="register-policy" required name="remember">
